...
export class ProcessingHelper {
  ...
  public loadStoredCredentials(): void {
    ...
    const deputyKey = credManager.getDeputyApiKey();
    if (deputyKey) {
      console.log("[ProcessingHelper] Loading stored Deputy API Key from CredentialsManager");
      this.llmHelper.setDeputyKey(deputyKey);
    }
