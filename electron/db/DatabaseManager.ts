...
export class DatabaseManager {
    ...
    private constructor() {
        ...
        this.dbPath = path.join(userDataPath, 'deputy.db');
        this.init();
    }

    public static getInstance(): DatabaseManager {
        if (!DatabaseManager.instance) {
            if (DatabaseManager.initError) {
                throw DatabaseManager.initError;
            }
            ...
            try {
                ...
                DatabaseManager.initError = normalized;
                throw normalized;
            }
        }
    ...
    private init() {
        try {
            ...
            if (message.includes('NODE_MODULE_VERSION') || message.includes('ERR_DLOPEN_FAILED')) {
                console.error('[DatabaseManager] Native module ABI mismatch detected. Run: npm run ensure:electron-native');
            }
...
Deputy is a real-time AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- Show or hide Deputy at any time:
  - **Mac**: Cmd + B
  - **Windows**: Ctrl + B
...
- **Usage**: Track your interaction history and see how Deputy assisted you.
...
### Undetectability
Unlock the **Undetectability** add-on to keep Deputy invisible during screen sharing.
...
**Once downloaded, return to Settings → Credentials in Deputy and select this file to complete setup.**
...
deputy.contact@gmail.com`;

        const demoMeeting: Meeting = {
            id: demoId,
            title: "Deputy Demo & Guide",
            date: today.toISOString(),
            duration: "5:00",
            summary: "Complete guide to using Deputy - your real-time AI meeting assistant.",
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: "Welcome to Deputy! Let me show you how it works.", timestamp: 0 },
                ...
                { speaker: 'user', text: "How do I hide Deputy during screen share?", timestamp: 60000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: 'What features does Deputy have?', answer: 'Deputy offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.' },
