...
import razaProfile from '../assets/raza.jpeg';
...
export const AboutSection: React.FC<AboutSectionProps> = () => {
    ...
    const handleOpenLink = (e: React.MouseEvent<HTMLAnchorElement>, url: string) => {
        ...
        if (url.includes('buymeacoffee.com/razakhanzas')) {
    ...
    return (
        <div className="space-y-6 animated fadeIn pb-10">
            {/* Header */}
            <div>
                <h3 className="text-lg font-bold text-text-primary mb-1">About Deputy</h3>
                <p className="text-sm text-text-secondary">Designed to be invisible, intelligent, and trusted.</p>
            </div>

            {/* What's New Section */}
            <div>
                <h4 className="text-xs font-bold text-text-tertiary uppercase tracking-wider mb-2 px-1"></h4>
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle overflow-hidden">
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h5 className="text-sm font-bold text-text-primary mb-1">Capture & Analyse ” {getPlatformShortcut(['ctrl', 'shift', 'Enter']).join('+')}</h5>
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    One shortcut to screenshot your screen and instantly get AI analysis. No extra clicks ” press {getPlatformShortcut(['ctrl', 'shift', 'Enter']).join('+')} and Deputy does the rest.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    AI-generated negotiation playbook built from your resume, job description, and live company culture data â€” opening line, justification, and counter-offer fallback, on demand.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-3 bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    Screenshots now flow automatically through any cURL-based or Ollama provider â€” no manual template edits needed. Bring your own model and get full vision support out of the box.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <h4 className="text-xs font-bold text-text-tertiary uppercase tracking-wider mb-2 px-1">How Deputy Works</h4>
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle overflow-hidden">
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                    ...
                    <div className="p-3 bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    A purely local vector memory system allows Deputy to recall details from past meetings. Embeddings and retrieval happen on-device via SQLite for maximum privacy.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                                Deputy listens only when active. It does not record video, take arbitrary screenshots without command, or perform background surveillance.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <a
                            href="https://deputy.software"
                            onClick={(e) => handleOpenLink(e, "https://deputy.software")}
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-bg-elevated border border-border-subtle flex items-center justify-center overflow-hidden shrink-0">
                                    <img src={razaProfile} alt="Raza Khan" className="w-full h-full object-cover" />
                                </div>
                                <div className="pt-0.5">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h5 className="text-sm font-bold text-text-primary">Raza Khan</h5>
                                    ...
                                    <p className="text-xs text-text-secondary leading-relaxed max-w-lg">
                                        ...
                                        <br />
                                        <span className="font-bold text-text-primary">Deputy</span> is made to feel fast, quiet, and respectful of your privacy.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 pl-[60px]">
                                <a
                                    href="https://github.com/Razakhan143/Deputy"
                                    onClick={(e) => handleOpenLink(e, "https://github.com/Razakhan143/Deputy")}
                                ...
                                <a
                                    href="https://x.com/razakhan143"
                                    onClick={(e) => handleOpenLink(e, "https://x.com/razakhan143")}
                                    className="text-text-tertiary hover:text-text-primary transition-colors"
                                    title="Twitter"
                                >
                                    <Twitter size={18} />
                                ...
                                <a
                                    href="https://www.linkedin.com/in/raza-khan-922612296/"
                                    onClick={(e) => handleOpenLink(e, "https://www.linkedin.com/in/raza-khan-922612296/")}
                                    className="text-text-tertiary hover:text-text-primary transition-colors"
                                    title="LinkedIn"
                                >
                                    <Linkedin size={18} />
                                ...
                                <a
                                    href="https://www.instagram.com/_raza_kz/"
                                    onClick={(e) => handleOpenLink(e, "https://www.instagram.com/_raza_kz/")}
                                    className="text-text-tertiary hover:text-text-primary transition-colors"
                                    title="Instagram"
                                >
                                    <Instagram size={18} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Love Deputy? Support us by starring the repo.</p>
                            </div>
                        </a>
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <a
                            href="mailto:razakhanzada100@gmail.com"
                            onClick={(e) => handleOpenLink(e, "mailto:razakhanzada100@gmail.com")}
                            className="whitespace-nowrap px-4 py-2 bg-text-primary hover:bg-white/90 text-bg-main text-xs font-bold rounded-lg transition-all shadow hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2"
                        >
                            <Mail size={14} />
                            Contact Me
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Deputy is independent open-source software.</p>
                            </div>
                        </div>
                        <a
                            href="https://buymeacoffee.com/razakhanzas"
                            onClick={(e) => handleOpenLink(e, "https://buymeacoffee.com/razakhanzas")}
