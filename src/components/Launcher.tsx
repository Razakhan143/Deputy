                                ...
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <h1 className="text-3xl font-celeb-light font-medium text-text-primary tracking-wide drop-shadow-sm">My Deputy</h1>
                                        ...
                                        <motion.button
                                            onClick={() => {
                                                if (isMeetingActive) {
                                                    ...
                                                    // the Deputy app or steal OS focus — preserves stealth.
                                                    ...
                                                    onStartMeeting();
                                                    analytics.trackCommandExecuted('start_deputy_cta');
                                                }
                                            }}
                                                ...
                                                <AnimatePresence mode="wait" initial={false}>
                                                    {isMeetingActive ? (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)] text-[20px] leading-none">Start Deputy</span>
                                                        </motion.div>
                                                    )}
                                                </AnimatePresence>
                                            </div>
