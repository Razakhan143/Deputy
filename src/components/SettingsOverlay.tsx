...
// ---------------------------------------------------------------------------
// MockupDeputyInterface — fake in-meeting widget for the opacity preview
// ---------------------------------------------------------------------------
const MockupDeputyInterface = ({ opacity }: { opacity: number }) => {
    ...
    return (
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none select-none bg-transparent">
                {/* DeputyInterface Widget — opacity controlled by the slider */}
                <div
                    id="mockup-deputy-interface"
...
const normalizeSettingsTab = (tab?: string): string => {
    if (!tab) return 'general';
    if (tab === 'api' || tab === 'deputy-api') return 'ai-providers';
    return tab;
};
...
const SettingsOverlay: React.FC<SettingsOverlayProps> = ({ isOpen, onClose, initialTab = 'general' }) => {
    ...
    useEffect(() => {
        if (isOpen && initialTab) {
            const resolvedTab = normalizeSettingsTab(initialTab);
    ...
    const hasProfileAccess = isPremium;
    ...
    const [showTranscript, setShowTranscript] = useState(() => {
        const stored = localStorage.getItem('deputy_interviewer_transcript');
        return stored !== 'false';
    });
    ...
    const [overlayOpacity, setOverlayOpacity] = useState<number>(() => {
        const stored = localStorage.getItem('deputy_overlay_opacity');
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
            localStorage.setItem('deputy_overlay_opacity', String(overlayOpacity));
        }, 150);
    ...
    const [sttProvider, setSttProvider] = useState<'none' | 'google' | 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'soniox' | 'deputy'>('none');
    ...
    const [hasDeputyKey, setHasDeputyKey] = useState(false);
        ...
        const loadSttSettings = async () => {
            try {
                ...
                if (creds) {
                    ...
                    setHasDeputyKey(creds.hasDeputyKey || false);
    ...
    // a provider auto-reconfigure like Deputy key clear).
    useEffect(() => {
    ...
    const handleSttProviderChange = async (provider: 'none' | 'google' | 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'soniox' | 'deputy') => {
    ...
    const handleTestSttConnection = async () => {
        if (sttProvider === 'none' || sttProvider === 'google' || sttProvider === 'deputy') return;
    ...
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto bg-bg-main p-8">
                                ...
                                <div className="space-y-6 animated fadeIn">
                                    <div className="space-y-3.5">
                                        ...
                                        <div className={`${isLight ? 'bg-bg-card' : 'bg-bg-item-surface'} rounded-xl p-5 border border-border-subtle flex items-center justify-between transition-all ${isUndetectable ? 'shadow-lg shadow-blue-500/10' : ''}`}>
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <p className="text-xs text-text-secondary">
                                                    Deputy is currently {isUndetectable ? 'undetectable' : 'detectable'} by screen-sharing. <button className="text-blue-400 hover:underline">Supported apps here</button>
                                                </p>
                                            </div>
                                            <div
                                                onClick={() => {
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-text-secondary mb-2">Customize how Deputy works for you</p>
                                            ...
                                            <div className="space-y-0">
                                                ...
                                                <div className="flex items-center justify-between px-4 py-3">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            <h3 className="text-sm font-bold text-text-primary">Open Deputy when you log in</h3>
                                                            <p className="text-xs text-text-secondary mt-0.5">Deputy will open automatically when you log in to your computer</p>
                                                        </div>
                                                    </div>
                                                    <div
                                                        onClick={() => {
                                                            ...
                                                            <div className="flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl bg-amber-500/10 border border-amber-500/20">
                                                                <div className="flex items-center gap-2.5 min-w-0">
                                                                    ...
                                                                    <p className="text-xs text-amber-200/80 leading-snug truncate">
                                                                        Logs → <span className="font-mono text-amber-300">~/Documents/deputy_debug.log</span>
                                                                    </p>
                                                                </div>
                                                                <button
                                                ...
                                                <div className="flex items-center justify-between px-4 py-3">
                                                    ...
                                                    <div
                                                        onClick={() => {
                                                            ...
                                                            localStorage.setItem('deputy_interviewer_transcript', String(newState));
                                                ...
                                                <div className="flex items-center justify-between px-4 py-3">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-text-secondary mt-0.5">Customize how Deputy looks on your device</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-start justify-between gap-4 px-4 py-3">
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-text-secondary mt-0.5">
                                                                You are currently using Deputy version {packageJson.version}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <button
                                    ...
                                    <div className={`${isLight ? 'bg-bg-card' : 'bg-bg-item-surface'} rounded-xl p-5 border border-border-subtle`}>
                                        <div className="flex flex-col gap-1 mb-3">
                                            ...
                                            <p className="text-xs text-text-secondary">
                                                Disguise Deputy as another application to prevent detection during screen sharing.
                                ...
                                <div className="space-y-5 animated fadeIn select-text pb-4">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-text-secondary">Deputy works with these easy to remember commands.</p>
                                        </div>
                                        <button
                                            ...
                                            <div className="bg-bg-card rounded-xl border border-border-subtle p-4 space-y-3">
                                                ...
                                                <div className="relative">
                                                    <ProviderSelect
                                                        ...
                                                        options={[
                                                            ...(hasDeputyKey ? [{ id: 'deputy', label: 'Deputy API', badge: 'Saved' as const, recommended: true, desc: 'Managed transcription via Deputy backend', color: 'blue', icon: <Mic size={14} /> }] : []),
                            ...
                            {activeTab === 'help' && (
                                <HelpSettings onNavigate={(tab) => setActiveTab(normalizeSettingsTab(tab))} />
                            )}
            ...
            >
                <MockupDeputyInterface opacity={previewOverlayOpacity} />
            </div>
        </AnimatePresence >
    );
};
