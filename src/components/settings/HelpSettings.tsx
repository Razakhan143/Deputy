...
import deputyIcon from '../icon.png';
                        ...
                        <motion.div key="usage" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.2 }} className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-bg-input flex items-center justify-center border border-border-subtle shrink-0">
                                    <img src={deputyIcon} alt="AI" className="w-3 h-3 opacity-50 object-contain force-black-icon" />
                                </div>
                                <div>
        ...
        <div className="w-full bg-bg-secondary rounded-[20px] border border-border-subtle overflow-hidden flex flex-col select-none pointer-events-none shadow-lg max-h-[280px]">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle shrink-0">
                <div className="flex items-center gap-2 text-text-tertiary">
                    <img src={deputyIcon} className="w-3.5 h-3.5 force-black-icon opacity-50" alt="logo" />
    ...
    return (
        <div className="flex justify-center flex-col items-center gap-4 py-8 bg-bg-card rounded-xl border border-border-subtle relative overflow-hidden h-[240px]">
             <div className="w-[300px] bg-bg-elevated border border-border-subtle rounded-xl shadow-lg p-4 z-10">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <img src={deputyIcon} alt="Deputy" className="w-6 h-6 object-contain rounded drop-shadow-sm opacity-90" />
                        <span className="text-text-primary text-sm font-medium">Deputy</span>
                    </div>
            ...
            <div className="text-xs text-text-secondary text-center max-w-[280px]">
                Deputy requires Accessibility and Screen Recording permissions to analyze screen context.
            </div>
        </div>
    );
};
        ...
        <div className="mt-4 space-y-2.5">
            ...
            <div className="flex items-center gap-3 p-3 bg-bg-elevated border border-border-subtle rounded-xl">
                <div className="w-8 h-8 rounded-full bg-bg-item-active flex items-center justify-center border border-border-muted shrink-0 shadow-sm">
                    <img src={deputyIcon} alt="Logo" className="w-[18px] h-[18px] object-contain force-black-icon opacity-90" />
                </div>
...
const MockProviderSelectionAnim = () => {
    ...
    const options = [
        { id: 'deputy', label: 'Deputy API', badge: '', recommended: true, desc: 'Ultra-fast low latency transcription', color: 'indigo', icon: <img src={deputyIcon} className={`w-[14px] h-[14px] object-contain opacity-80 ${isLight ? '' : 'filter brightness-0 invert'}`} alt="Deputy"/> },
    ...
    const steps = [
        {
            ...
            desc: 'Enable Screen Recording and Accessibility for Deputy in macOS Privacy & Security.',
        },
        {
            title: 'Set Up Audio',
            desc: 'Open Settings → Audio and select Deputy API, or paste a Deepgram or Google key.',
        },
        {
    ...
    return (
        <div className="mb-10">
            <div className="mb-7">
                ...
                <p className="text-[13px] text-text-tertiary mt-0.5">Get Deputy running in four steps.</p>
            </div>
...
export const HelpSettings: React.FC<{ onNavigate?: (tab: string) => void }> = ({ onNavigate }) => {
    ...
    // Kbd class applying theme variables deputy
        ...
        <div className="w-full h-full flex flex-col animated fadeIn pb-10">
            <div className="mb-6 shrink-0">
                ...
                <p className={`text-sm text-text-secondary mt-3 max-w-2xl`}>
                    Learn how to deeply configure Deputy. Everything from providing the right API scopes to executing conversational interviews seamlessly is covered below.
                </p>
            </div>
            ...
            <div className="flex-1 space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 flex-1">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-[13px] text-text-secondary">
                                    Configure your <span className="font-semibold text-text-primary">AI Providers</span> once for a reliable, key-based setup that works across all app features.
                                </p>
                            </div>
                        </div>
                ...
                <AccordionSection title="1. App Permissions Setup" icon={<Monitor className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <p>Deputy operates entirely on-device, but requires OS permissions to tap into your screen context and global keystrokes.</p>
                        {/* <MockPermissionsAnim /> */}
                    <div className="space-y-3 mt-4">
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-2`}>
                                ...
                                <p className="text-[11px] opacity-90 leading-relaxed text-text-secondary">
                                    Deputy can capture both what you say and what you hear globally. At the top of the Audio Settings, use the Dropdowns to explicitly select your hardware Input (e.g. your physical microphone) and Output capture (what the speakers play). By default, Deputy utilizes the <strong>System Default</strong>, so audio routing will automatically follow your OS preferences.
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col gap-3 mt-6">
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                ...
                                <p className="text-xs opacity-90 mb-2">Provides Deputy the ability to read your screen temporarily when you capture context.</p>
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                ...
                                <p className="text-xs opacity-90 mb-2">Required for Deputy to detect the global keyboard shortcuts below, regardless of what window is focused.</p>
                ...
                <AccordionSection title="2. Audio STT Providers Setup (Microphone)" icon={<Mic className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p>Deputy supports over 8 different Audio engines to transcribe what you hear and say. From the Audio tab in settings, use the overarching dropdown to switch the active engine.</p>
                ...
                <AccordionSection title="3. AI Providers & Prompt Engine" icon={<Key className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <p className="text-sm">Deputy uses Large Language Models (LLMs) to reason about your screen and audio context. You can configure cloud providers, local models, or fully custom endpoints.</p>
                        ...
                        <div className="space-y-3 pt-4">
                             ...
                             <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                 <p className="text-xs opacity-90 leading-relaxed text-text-secondary">
                                     You can run Deputy completely offline with 100% data privacy using Ollama. Deputy automatically scans <span className={kbdClass}>http://localhost:11434</span> for active models.
                                 </p>
                                 <ol className="list-decimal pl-4 text-xs space-y-2 opacity-90 text-text-secondary">
                                     ...
                                     <li>Alterdeputy, for faster generation without GPU, use Microsoft's smaller model:
                                        <div className="mt-1 bg-bg-input p-2 rounded border border-border-subtle font-mono text-[11px]">ollama run phi3</div>
                                     </li>
                                     <li>Return to Deputy's AI Providers overlay, and you will see your Local models ready for usage.</li>
                                 </ol>
                             </div>
                        </div>
                             ...
                             <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                 ...
                                 <div className="flex items-start gap-2 mt-2">
                                     ...
                                     <div className="text-xs text-text-secondary leading-relaxed">
                                         <strong>Crucial: The Response Path.</strong> You must inform Deputy how to parse the JSON text back. Deeply nested outputs must define the exact path array. For OpenAI/OpenRouter compliant endpoints, this is strictly: <span className={kbdClass}>choices[0].message.content</span>.
                                     </div>
                                 </div>
                             </div>
                        </div>
                ...
                <AccordionSection title="4. Deputy Interface Operations" icon={<Monitor className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p className="text-[13px]">When initialized, Deputy hides itself visually while remaining active as a persistent translucent overlay. This is your command center.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="p-4 bg-bg-item-surface border border-border-subtle rounded-xl shadow-sm hover:border-border-muted transition-colors group">
                                ...
                                <p className="text-[12px] text-text-secondary leading-relaxed">
                                    Deputy fires a local background job as soon as the meeting finishes to compress the entire raw audio transcript into clean, formatted markdown representing structural overviews and explicit action items.
                                </p>
                            </div>
                ...
                <AccordionSection title="6. Global Search & Shortcuts" icon={<Search className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p className="text-[13px]">Hit <span className={kbdClass}>Cmd+K</span> anywhere on your computer to invoke the Deputy Global Palette. This acts as your Spotlight overlay for interacting directly with the system backbone.</p>
                        ...
                        <div className="border-t border-border-subtle pt-6">
                            ...
                            <p className="text-[11px] text-text-secondary mt-1 mb-3">These hotkeys work anywhere on your operating system, regardless of whether Deputy is focused or completely hidden. Change them via <strong>Settings &gt; Hotkeys</strong>.</p>
                                 ...
                                 <div className="flex items-center justify-between p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-text-secondary mt-1">Triggers Deputy to analyze the captured screenshots and text from the rolling buffer.</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-1 shrink-0">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                <div className="p-4 rounded-xl border bg-accent-primary/5 border-border-subtle">
                                    ...
                                    <p className="text-[11px] text-text-secondary mb-2">
                                        This is a Deputy Pro feature. 
                                    </p>
                                    <ol className="text-[11px] text-text-secondary space-y-1 list-decimal pl-4 mb-0">
                                        <li>Get a License at <button onClick={() => { (window as any).electronAPI?.openExternal('https://deputy.software/') }} className="text-accent-primary hover:underline font-semibold">deputy.software</button></li>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl mb-4">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                    By connecting your Google Calendar directly to Deputy, the AI automatically gains context on your upcoming meetings, syncs the event data, and reads attendee lists to hyper-personalize your interactions.
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>Deputy will quietly background-sync your schedule.</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary">Follow-Up System</h4>
                                    <p className="text-[11px] text-text-secondary">
                                        When tracking live meetings, Deputy uses the connected calendar context to instantly figure out <strong>who you are talking to</strong>. This powers the Follow-Up Email system, letting you auto-draft post-meeting notes to confirmed attendees.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <AccordionSection title="9. Stealth & Window Control" icon={<Ghost className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Deputy is heavily geared towards power users seeking minimalistic operation. The process completely disguises itself and remains undetectable/invisible to standard screen-recording applications and desktop sharing utilities.
                            </p>
                        </div>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <div className="p-2 border border-orange-500/20 bg-orange-500/5 rounded-lg">
                                    <p className="text-[10px] text-orange-400 m-0">
                                        <strong>⚠️ Warning:</strong> This renders the Deputy overlay completely unclickable. You MUST memorize the Global Hotkeys (e.g. <strong>Cmd+Shift+Arrows</strong> to move, <strong>Cmd+B</strong> to hide, <strong>Cmd+1-7</strong> for actions) to control the application once this is active.
                                    </p>
                                </div>
                            </div>
                        </div>
