...
export type SttProviderId = 'google' | 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'deputy';
...
export const STT_PROVIDERS: Record<SttProviderId, SttProviderConfig> = {
    ...
    deputy: {
        id: 'deputy',
        name: 'Deputy Pro (Managed)',
        description: 'All-in-one managed STT via Deputy API',
        endpoint: '', 
        model: '',
        uploadType: 'websocket',
        authHeader: () => ({}),
