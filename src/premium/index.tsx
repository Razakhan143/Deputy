...
const _deputyApiPromo = import.meta.glob<any>(
  '../../premium/src/DeputyApiPromoToaster.tsx',
  { eager: true }
);
...
export const DeputyApiPromoToaster: React.FC<any> =
  get(_deputyApiPromo, 'DeputyApiPromoToaster', NullComponent);
